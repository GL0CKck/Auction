    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.SmallIntegerField(db_index=True, default=0, verbose_name='')),
            ],
        ),
        migrations.CreateModel(
            name='SubCategory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.subcategory', verbose_name='Рубрика')),
            ],
        ),
        migrations.AddField(
            model_name='category',
            name='super_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main.supercategory', verbose_name='Надрубрика'),
        ),
    ]
