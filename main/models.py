...
class Category(models.Model):
    name = models.CharField(
        max_length=255, db_index=True, unique=True, verbose_name="Название"
    )
    order = models.SmallIntegerField(
        default=0, db_index=True, verbose_name="Сортировка"
    )
...
class Product(models.Model):
    ...
    created = models.DateTimeField(
        auto_now_add=True, db_index=True, verbose_name="Опубликованно"
    )
    author = models.ForeignKey(
        AdvUser, on_delete=models.CASCADE, verbose_name="Продавец"
    )
    ...
    super_product = models.ForeignKey(
        "SuperProduct",
        on_delete=models.PROTECT,
...
class Tip(models.Model):
    ...
    author = models.ForeignKey(
        AdvUser, on_delete=models.CASCADE, verbose_name="Покупатель"
    )
    time_tip = models.DateTimeField(
