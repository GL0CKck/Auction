...
from .views import index, by_category, PpRegisterView, profile, PpLoginView, PpLogoutView, RegisterUserDone, \
    ChangeUserInfo, DeleteUser, detail, profile_pp_add, RegistrationAPIView, LoginAPIView, profile_pp_change, \
    profile_pp_delete, user_tips, user_tips_delete, ProductViewSet, ProductDetailApi, ProductListApi, TipProductApi, \
    TipProductViewSet
