...
urlpatterns = [
    ...
    path(
        "api/product_detail/<int:category_pk>/<int:pk>/",
        ProductDetailApi.as_view(),
        name="product_detail",
    ),
    path(
        "api/tip/product/<str:name>/", TipProductApi.as_view(), name="products_detail"
    ),
    ...
    path(
        "accounts/profile/change/product/<int:pk>",
        profile_pp_change,
        name="profile_pp_change",
    ),
    path(
        "accounts/profile/delete/product/<int:pk>",
        profile_pp_delete,
        name="profile_pp_delete",
    ),
    path("accounts/logout/", PpLogoutView.as_view(), name="logout"),
    path("accounts/profile/", profile, name="profile"),
    path("accounts/profile/tips/", user_tips, name="user_tips"),
    path(
        "accounts/profile/tips/delete/<int:pk>",
        user_tips_delete,
        name="user_tips_delete",
    ),
